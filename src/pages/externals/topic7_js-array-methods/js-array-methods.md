...
**compareFunction** - это функция _компаратор_, которая принимает два аргумента - значения, которые необходимо сравнить определенным образом. Возможные возвращаемые значения:
-  `0` элементы равны
