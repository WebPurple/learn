...
Кроме базового оператора присваивания существуют операторы вспомогательного присваивания. Они совмещают себе какую-либо арифметическую или побитовую операцию и оперцию присваивания.
